...
public class ChatView extends RelativeLayout {
    ...
    private void getUseEditorAction() {
        useEditorAction = attributes.getBoolean(R.styleable.ChatView_inputUseEditorAction, true);
    }
    ...
    private void sendMessage(String message,  String username) {
        ...
        Message chatMessage = new Message(message, Message.Type.SENT, username, "32324223424");
    ...
    public interface OnSentMessageListener {
        boolean sendMessage(Message chatMessage);
    }
    ...
    private class ChatViewListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            holder.getUsername().setText(chatMessages.get(position).getUsername());
        ...
        private void addMessages(ArrayList<Message> chatMessages) {
        ...
        class ViewHolder {
            ...
            private TextView getUsername() {
                if (timestampTextView == null) {
                    timestampTextView = (TextView) row.findViewById(R.id.username);
                }
